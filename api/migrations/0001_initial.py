# Generated by Django 3.1.1 on 2020-10-13 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hour_sheet', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.timemaster')),
            ],
            options={
